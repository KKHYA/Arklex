...
- Car Advisor Worker:
  - Comprehensive vehicle recommendation and analysis (car_advisor_worker.py)
- Car Database Worker:
  - Specialized automotive database operations and queries (car_database_worker.py)
...
- Comprehensive vehicle advisory workflows
- Multi-phase automotive analysis
